...
%  mkdir '/Users/oviyat/Desktop/CX/cardiomegaly3'
%  mkdir '/Users/oviyat/Desktop/CX/edema3'
...
for i = 1:length(rc)
    ...
    imwrite(A,['/Users/oviyat/Desktop/CX/cardiomegaly3/',car]);
end
...
for i = 1:length(re)
    ...
    A = imread(filename);
    A = imresize(A,[224 224]);
    imwrite(A,['/Users/oviyat/Desktop/CX/edema3/',ed]);
end
