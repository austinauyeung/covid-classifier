...
%% Crop all images in images_processed_2 folder
...
%% Sort cropped photos into respective classes
listings = dir([source,'cropped_processed/']);
c = [];
h = [];
p = [];
clast = {};
...
%% Sorting each unique image in covidfigures excel doc into a folder
